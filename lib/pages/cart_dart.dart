      ...
      appBar: AppBar(
        leading: new IconButton(
          ...
          onPressed: () => {
            ...
            Provider.of<SeatP>(context, listen: false).initP('1')
          },
        ),
                ...
                children: [
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(width: 1,color: Color.fromRGBO(100, 100, 100, 0.2)),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Text(
                            ...
                            style: TextStyle(fontSize: ScreenUtil().setSp(45),height: 1.5,color: Colors.black87),
