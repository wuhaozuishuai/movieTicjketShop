...
class RootPageState extends State<RootPage>
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            ///构建用户输入手机号UI
            buildUserRowWidgets(Icons.phone_android, "清输入用户名",
                userPhoneFieldNode, _userPhoneTextController, isPhoneError, 1),
            //间隔
            SizedBox(
              height: 22,
            ),
            ...
            ///构建启用输入密码UI
            buildUserRowWidgets(Icons.lock_open, "请输入密码", userPasswordFieldNode,
                _userPasswrodtController, isPasswordError, 2),
    ...
    return Transform.translate(
        ...
        child: Container(
          ...
          child: buildInputItemRow(
              preIconData, hintText, focusNode, controller, i),
        ));
  }
  ...
  ///[focusNode] 焦点控制
  ///[controller]输入框控制器
  buildInputItemRow(IconData preIconDate, String hintText, FocusNode focusNode,
      TextEditingController controller, int i) {
    return Row(
      children: [
        ///左侧小图标
        Padding(
...
//          });
          await myRequest('login',
                  formData: {"username": inputPhone, "password": inputPassword})
              .then((value) {
            ...
            if (status != 1) {
              ...
              Future.delayed(Duration(milliseconds: 500), () {
                ...
                //     .userLogin(int.parse(data['userId']));\
